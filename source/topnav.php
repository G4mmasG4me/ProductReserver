<header id="header" class="w-100 top">
  <nav class="navbar justify-content-center w-100">
    ...
    <div class="navbar-nav w-100 align-items-center justify-content-center flex-grow-2">
      ...
      <button class="nav-item" onclick="location.href='admin.php'">How It Works</button>
      <button class="nav-item" onclick="location.href='admin.php'">Recommend A Product</button>
      <button class="nav-item" onclick="location.href='signup.php'">Contact Us</button>
    </div>
